...
* Delete Groups only possible if Group has no users
* Deleting a user removes it from all groups
...
- `elm-app start` -> This should point your browser to localhost:3000

For reference i kept the original documentation for `create-elm-app` below:
